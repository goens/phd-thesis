...
\begin{figure}[h]
   ...
   \caption{The four main abstractions in Software Synthesis in the Example of a \acs{KPN}-based flow.\todo{improve figure: add a flow}} 
...
how to program heterogeneous multicore architectures with increasing complexity. 
