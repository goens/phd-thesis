The first part of this thesis deals with improving dataflow-based software synthesis.
...
The first part of the thesis thus deals with design flows based around mapping dataflow applications to heterogeneous \acp{MPSoC}, on the example of a flow based on \acp{KPN}, but including other models of computation.
