A second use-case we have investigated for for the Reactors model is the 5G standard. 
...
In a traditional setup, with a static implementation of the PHY layer, we would make worst-case assumptions.
