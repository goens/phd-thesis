...
A reason for this is that the original formalization has some mathematical inaccuracies and unspecified behavior.
...
An andvantag of this formalization is that it relates \acp{KPN} and rectors formally.
...
Note that our definition restricts is a restriction on the definition of reactions.
