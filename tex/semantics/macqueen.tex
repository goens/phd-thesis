...
This is because we (arbitrarily) choose to read $I1$ before $I2$.
If we reverse this order, the implementation would block on Case 2 instead, leaving unread tokens in the channel $I1$.
...
Consider the Gantt-chart depicted in Figure~\ref{fig:macqueen_example_gantt}.
...
\begin{figure}[h]
	%\centering
   \resizebox{0.85\textwidth}{!}{\input{figures/data_parallel_kpn.tex}}
