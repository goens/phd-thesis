...
\begin{figure}[t]
	...
	\caption{ Dependencies of \mintinline{Haskell}{(map (f . g . h) inputs)}. Adapted from Figure~5 in~\ref{ertel_haskell19}}
...
The individual states $S_i$ for $i \in N$ we call fundamental states. We thus formally define a \emph{state thread}\index{state thread} as a morphism:
\begin{align*}
