...
Figure~\ref{fig:achitecture_abstractions} summarizes different models used at different levels in achitecture.
...
Figure~\ref{fig:arch_graph_vs_topology} shows the difference of the architecture graph $A$ and the topology graph $T$ for a $4 \times 4$ regular mesh NoC topology.
