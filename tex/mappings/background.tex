...
In the Sesame framework~\cite{sesame}, an additional abstraction layer called the \emph{mapping layer} works as an intermediate virtual platform, in correspondence with the \ac{KPN}, application, which is then mapped to the target platform.\index{mapping layer}
...
This is similar to the model described in~\cite{sesame}.
...
As can be seen from Figure~\ref{fig:software_synthesis_flow} in the introduction, this is a central problem in software synthesis.
