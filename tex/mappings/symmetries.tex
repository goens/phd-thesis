...
\resizebox{0.9\textwidth}{!}{
\begin{tikzpicture}
   \input{figures/audio_filter_symmetries}
 \end{tikzpicture}
}
...
\begin{tikzpicture}
   \input{figures/odroid_af_symmetries}
 \end{tikzpicture}
}
...
\begin{figure}[h]
   ...
   \resizebox{0.95\textwidth}{!}{
      \begin{tikzpicture}
      \input{figures/fourbyfour_partial_motivation.tex}
      \end{tikzpicture}
      }
...
\begin{figure}[h]
   ...
   \resizebox{0.95\textwidth}{!}{
      \begin{tikzpicture}
      \input{figures/fourbyfour_partial_example.tex}
      \end{tikzpicture}
      }
