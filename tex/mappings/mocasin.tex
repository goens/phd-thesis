In this thesis we will use \mocasin, a tool for the \ac{MoC}-based analysis and simulation of applications~\cite{menard_rapido21}.
...
The tool boasts multiple readers to generate the internal data structures from established formats like \texttt{tgff}~\cite{tgff}, \texttt{sdf3}~\cite{sdf3} or the \texttt{MAPS} formats. \index{tgff}\index{\acs*{\SDFFF}}
