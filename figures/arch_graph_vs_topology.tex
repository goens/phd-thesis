...
\begin{scope}[xshift=-170,yshift=-80,scale=1/2,every node/.append style={scale=1/2}]
  \node[rectangle,thick,minimum width = 2cm, minimum height=2cm,fill=green!30] at (1,1) {\Huge PE$_1$};
  \node[rectangle,thick,minimum width = 2cm, minimum height=2cm,fill=green!30] at (5,1) {\Huge PE$_2$};
  \node[rectangle,thick,minimum width = 2cm, minimum height=2cm,fill=green!30] at (1,5) {\Huge PE$_3$};
  \node[rectangle,thick,minimum width = 2cm, minimum height=2cm,fill=green!30] (pe4-arch) at (5,5) {\Huge PE$_4$};
  \foreach \x in {0,...,1}{
    \foreach \y in {0,...,1}{
