...
\begin{tikzpicture}[node distance = 4em]
    %nodes
    \node [ours,align=center ] (moc) {application \\ (\ac{MoC}) e.g. \ac{KPN} };
    ...
    \node (mapping) at (3.5,-0.6) [single arrow,
                                    ...
                                    minimum width=2.5cm,minimum height=1cm,] {\ac{DSE} \\ (mapping/scheduling)};
    ...
    \node [ours, minimum height=6em, align=center] (mapping) at (7.8,-0.6) {mapping \\ (and schedule)};
