...
## R scripts builder
Rscript_builder = Builder(action='Rscript $SOURCE',
                      suffix=build_config.FILE_EXTENSIONS['tikz'],
                      src_suffix=build_config.FILE_EXTENSIONS['R'])
env.Append(BUILDERS={'Rscript': Rscript_builder})
